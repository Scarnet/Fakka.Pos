...
//https://github.com/danielkatz/RtlScrollViewFix/tree/master/RtlScrollViewFix

[assembly: ExportRenderer(typeof(Xamarin.Forms.ScrollView), typeof(ScrollViewExtensionRenderer))]
namespace Fakka.Droid.Renderers
{
    public class ScrollViewExtensionRenderer : ScrollViewRenderer
    {
        LayoutDirection currentDirection;
        public ScrollViewExtensionRenderer(Context context) : base(context)
        {
